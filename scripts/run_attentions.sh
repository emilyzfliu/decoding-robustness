...
# after verified
# for ptb_type in 'char' 'token' 'shuffle' 'word' 'synonym' 'typo' 'adv'; do
#     python analysis/attentions.py --model 'gpt2' --ptb-type $ptb_type --ptb-pct 5 --out-root res_attentions_0820
#     python analysis/attentions.py --model 'gpt2' --ptb-type $ptb_type --ptb-pct 30 --out-root res_attentions_0820
# done
